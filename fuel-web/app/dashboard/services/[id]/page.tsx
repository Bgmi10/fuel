              ...
              (
                ...
                return (
                  <div
                    ...
                    className="flex flex-col justify-between gap-5 p-5 md:flex-row md:items-start"
                  >
                    <div className="min-w-0">
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        >
                          ...
                          {isSessionBased
                            ? `${servicePackage.totalSessions || 0} SESSIONS`
                            : "UNLIMITED ENTRY"}
                        </span>
                      </div>
              ...
              >
                ...
                <div className="flex justify-end gap-3 border-t border-zinc-800 pt-5">
                  <button
                    ...
                    className="rounded-xl bg-zinc-800 px-5 py-2.5 text-sm text-white transition hover:bg-zinc-700"
                  >
                    Cancel
                  </button>
