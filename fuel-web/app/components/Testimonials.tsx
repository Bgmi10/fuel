...
const testimonials = [
  ...
  },
  {
    ...
    time: "4 months ago",
    text: "It’s been 3 months since I joined Fuel Gym and honestly, I didn’t expect to enjoy going to the gym this much since it’s my first one.",
  },
  {
    name: "Surya Jeeva",
    profile:
    ...
    time: "4 months ago",
    text: "Their team of five is really good. For a beginner like me there should be proper guidance to motivate and build up. So I was in search of a gym to get joined and by looking at Google reviews I wanted to join here at Fuel Gym.",
  },
  {
    name: "O B VISHNU",
    profile:
    ...
    time: "2 months ago",
    text: "My first shot at any gym. Functional training was more practical and hence tried. Great experience. Seemed easy from outside but actually tough and really efficient. Coaches are very supportive and motivating here.",
  },
  {
    name: "Yamini Sekar",
    profile:
    ...
    time: "6 months ago",
    text: "Hello Fuel team!! I would like to take this opportunity to sincerely thank the Fuel Gym team. A month ago, my daughter introduced me to this gym and encouraged me to join.",
  },
  {
    name: "Swetha Rawal",
    profile:
    ...
    time: "2 months ago",
    text: "Really good experience, great guidance. The trainers are knowledgeable, supportive, and always motivate me to push my limits. The workouts are also well planned.",
  },
  {
    name: "Karthick Rock",
    profile:
    ...
    time: "8 months ago",
    text: "Fuel Gym is truly the BEST functional training gym, offering best functional workouts, strength training, and body transformation. I have reduced from 87 kg to 71 kg — 16 kg — delivering real, healthy, and long-lasting results.",
  },
  {
    name: "Esther Grace",
    profile:
    ...
    time: "5 months ago",
    text: "Joining Fitness Yoga was one of the best decisions for my health in Fuel Yoga online classes. After regular sessions, I feel stronger, more flexible, and mentally relaxed. Nithya ma'am guides everyone with patience and is very supportive and motivating. It’s perfect for improving stamina, body strength, and overall well-being.",
  },
  {
  ...
  },
  {
    ...
    time: "7 months ago",
    text: "I have been going to Fuel Gym for the past 6 months and I’ve lost 5 kilos. I also have spinal issues, and the trainers take excellent care and guide me very carefully according to my condition.",
  },
  {
    name: "Rachna",
    profile:
    ...
    time: "7 months ago",
    text: "Fuel gym isn't like any other regular gym. This place has not only made my fitness journey incredible but also provided mental peace and stability. I've been coming here since the past two years.",
  },
  {
    ...
    time: "7 months ago",
    text: "Fuel Gym Chennai keeps me motivated every single day. Amazing trainers, great workout plans, and a friendly crowd. If you’re looking for real results and a positive vibe, this is the place to be! Absolutely love it.",
  },
  {
    name: "Gokul",
    profile:
    ...
    time: "9 months ago",
    text: "Fuel Gym is unlike any regular gym — it’s a place where every session pushes you beyond your limits. The workouts are always dynamic, challenging, and fun.",
  },
  {
    ...
    time: "9 months ago",
    text: "Started as a beginner being so skeptical whether gym and functional training were out of my reach, but honestly with the help of Coach Arif sir, Naren sir and Raghav sir it doesn't feel tough or monotonous.",
  },
  {
    name: "JAYANTHI B L",
    profile:
    ...
    time: "7 months ago",
    text: "As a yoga teacher, I'd like to share my thoughts about the functional training in this gym. I joined this gym to improve my strength and stability. Initially it was very tough for me to complete the required duration.",
  },
];
